...
async function callOtelMcpTool(toolName: string, args: Record<string, unknown>): Promise<string> {
 ...
 */
export async function traceAgent(state: typeof StateAnnotation.State) {
